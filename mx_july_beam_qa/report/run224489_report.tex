...
nominal HV span 3.5\,mV (DR) to 10.3\,mV (CL), i.e.\ 0.69--2.04\,mV/MeV
against the expected 5.05\,MeV deposit in 2.5\,cm of PVT; the DR and BL MIPs
sit at or below the recommended 4.9\,mV trigger threshold. (3)~The FIFO recovers only
...
MPV convention means. The calibration therefore uses error-weighted MPV fits
on the linear per-step spectra at $V\geq1400$\,V --- where the peak is well
clear of the threshold --- transported to the nominal voltage with each PMT's
high-statistics coincident-median exponent $n$ (Fig.~\ref{fig:mipvsv} shows
the log-mode version of the transport; Table~\ref{tab:mip} the adopted MPV
values). The MPV transport is also markedly more stable: internal spreads of
6--12\% for five PMTs (largest 31\% on AR, whose steps split into two
groups --- flagged), vs.\ 10--78\% for the log modes.
...
\begin{tabular}{lrrrrrr}
\toprule
PMT & $V_{\rm nom}$ [V] & $n$ & MPV [ADC] & MPV [mV] & spread & mV/MeV\\
\midrule
PSSA1 (AL) & 1325 & 6.94 & 325 &  9.9 & 11\% & 1.96\\
PSSA2 (AR) & 1275 & 5.08 & 215 &  6.6 & 31\% & 1.31\\
PSSB1 (BL) & 1325 & 5.19 & 144 &  4.4 &  7\% & 0.87\\
PSSB2 (BR) & 1300 & 7.10 & 226 &  6.9 & 12\% & 1.37\\
PSSC1 (CL) & 1300 & 3.80 & 336 & 10.3 & 26\% & 2.04\\
PSSC2 (CR) & 1300 & 6.64 & 201 &  6.2 & 22\% & 1.23\\
PSSD1 (DL) & 1300 & 5.77 & 175 &  5.4 &  8\% & 1.07\\
PSSD2 (DR) & 1300 & 6.39 & 112 &  3.5 &  6\% & 0.69\\
\bottomrule
\end{tabular}
\caption{Plastic MIP (linear-space MPV) at nominal HV and absolute
calibration. The energy scale assumes the normal-incidence minimum-ionizing
deposit in 2.5\,cm of PVT
...
(the earlier log-binned-mode values, 15--35\% higher, are preserved there as
...
\textbf{at the current HV the DR (3.5\,mV) and BL (4.4\,mV) MIPs are at or
...
\item The plastic MIP is measured for the first time:
      0.69--2.04\,mV/MeV at nominal HV. \textbf{Apply the new equalization}
