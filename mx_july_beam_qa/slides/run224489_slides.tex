...
\centering
\includegraphics[height=.8\textheight]{12_hv_scan/scan_timeline.png}
\end{frame}
...
\centering
\includegraphics[height=.78\textheight]{run224489/autopsy/dup_veto_spectra.png}
\end{frame}

\begin{frame}{HV scan: wall MIP again immune to plastic HV (now incl.\ arm A)}
\centering
\includegraphics[height=.72\textheight]{12_hv_scan/wall_mip_stability.png}
...
\centering
\includegraphics[height=.78\textheight]{12_hv_scan/gain_curves.png}
\end{frame}

\begin{frame}{Result 2 --- the FIFO gain ratio is \textbf{1.4}, not 2}
\centering
\includegraphics[height=.68\textheight]{19_triples/fifo_ratio.png}
...
\centering
\includegraphics[height=.7\textheight]{19_triples/liq_wide_dt.png}
...
\centering
\includegraphics[height=.8\textheight]{19_triples/liq_timing.png}
\end{frame}

\begin{frame}{The triple telescope: why LIQ unlocks the \emph{plastic} MIP}
\centering
\includegraphics[height=.7\textheight]{11_diagrams/concept_wall_plastic_liq.png}
...
\begin{frame}{Result 4 --- the plastic MIP, found}
\centering
\includegraphics[height=.72\textheight]{19_triples/pss_mip_spectra.png}

{\small Net triples 9.2 k (CL) -- 49.5 k (BR); the hump marches with HV;
red = nominal-HV window. Wall spectrum in triples unchanged (backup).}
\end{frame}

\begin{frame}{Plastic MIP vs HV $\to$ calibration at nominal}
\centering
\includegraphics[height=.78\textheight]{19_triples/pss_mip_vs_v.png}
\end{frame}
...
\centering
\includegraphics[height=.62\textheight]{19_triples/liq_position_map.png}
...
\begin{columns}
\column{.52\textwidth}
\includegraphics[width=\textwidth]{19_triples/offset_shift.png}

{\small All 64 wall--plastic offsets shifted by a \textbf{common
$-22.27$ ns (rms 0.22 ns)}.}
\column{.46\textwidth}
\includegraphics[width=\textwidth]{19_triples/satellite.png}
...
\centering
\includegraphics[height=.78\textheight]{19_triples/wall_in_triples.png}
\end{frame}

\begin{frame}{Backup: triple-tagged LIQ spectra (C/D low)}
\centering
\includegraphics[height=.7\textheight]{19_triples/liq_spectra.png}
...
\centering
\includegraphics[height=.78\textheight]{12_hv_scan/coinc_spectra_linear.png}
\end{frame}

\begin{frame}{Backup: trigger threshold scan at equalized gains}
\centering
\includegraphics[height=.78\textheight]{12_hv_scan/threshold_scan.png}
\end{frame}
