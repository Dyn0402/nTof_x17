...
{\scriptsize $^{*}$AR's steps split into two groups --- flagged. Energy
scale: 5.05 MeV in 2.5 cm PVT (normal incidence).}
\column{.45\textwidth}
\begin{itemize}
\item Error-weighted MPV fits on the linear per-step spectra
      ($V\geq$1400 V), transported to nominal V with each PMT's
      coincident-median $n$.
\item First-pass log-binned modes were 15--35\% high (mode of
      $dN/d\log A$ $\neq$ MPV of $dN/dA$) --- corrected; spreads improved
      to 6--12\% for five PMTs.
\item MIP-based inter-PMT ratios agree with the equalization table ---
      independent cross-check.
\item \alert{DR (3.5 mV) and BL (4.4 mV) MPVs sit at/below the 4.9 mV
...
\item \textbf{First plastic MIP calibration}: 0.69--2.04 mV/MeV at nominal HV
