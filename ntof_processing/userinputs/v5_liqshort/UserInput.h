...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#
# X17 EAR2 2026 -- variant v5_liqshort  =  v4_walshapes  +  SHORT averaged
# liquid templates.
#
# The retry on the liquids.  v3_shapes lost because a 551 ns template for a
# 6 ns FWHM pulse is ~500 ns of baseline noise, not because averaging was
# wrong.  These are 81 ns -- the same scale as the shipped ones -- but built
# from 47-921 clean pulses each instead of a single raw pulse, and one set
# per liquid instead of two shapes shared across all four.
# If this still loses to v4, the shipped templates stay and the liquids are
# limited by something other than the template.
#
# v3_shapes replaced the pulse-shape templates of BOTH the walls and the
# liquids.  Graded on the first reprocessing (FINDINGS 4b): the wall change
# is a clear win (chi2 p50 1.23->1.00 on WALB, 1.18->1.06 on WALD, amplitudes
# up, 2-3 % fewer hits = spurious splits gone) and the liquid change is a
# clear loss (chi2 p50 more than doubles, amplitudes down ~30 %, up to a
# third of the hits gone) because a 551 ns template for a 6 ns FWHM pulse is
# mostly baseline noise.  So: keep the wall templates, revert the liquids to
# Riccardo's shipped ones.
#
