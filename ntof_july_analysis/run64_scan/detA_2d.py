...
right default here because run_64's FEU dropouts (see feu_presence.py) leave the
...
Run: .venv/bin/python ntof_july_analysis/run64_scan/detA_2d.py
Output -> <ANALYSIS_DIR>/July_HV_Scan/run64_scan/detA/
"""
import os
import sys
...
def fig_heatmaps(st):
    ...
    fig.suptitle('run_64 Det A — RAW (un-smoothed) 2-D drift x resist efficiency, '
...
def fig_profiles(st):
    ...
    fig.suptitle('run_64 Det A — raw 1-D slices through the 2-D scan '
