...
STYLES = {
    ...
    "Cosmics":       {"color": "#0e7490", "text_color": "#cffafe", "pattern": "dashed"},
}
...
BANDS = [
    ...
    {"label": "Cosmics\nResist HV Scan\nRack Room\nArgon CF4","legend_label": "Cosmics", "optional": False,
     "start": datetime(2026, 5, 10, 14, 30),    "end": datetime(2026, 5, 10, 16)},
    {"label": "Prep for\nEAR2 Setup",          "legend_label": "Setup",
     "start": datetime(2026, 5, 10, 16, 30),    "end": datetime(2026, 5, 10, 18, 30)},
    {"label": "Cosmics\nResist HV Scan\nRack Room\nArgon CF4","legend_label": "Cosmics", "optional": False,
    ...
    {"label": "Resist HV Scan\nArgon CO2\n3mm Drift\nCarbon Capsule", "legend_label": "Measurement",
     "start": datetime(2026, 5, 13, 21, 45),   "end": datetime(2026, 5, 14, 8, 0)},
    {"label": "Gas Switch\nAr/CO2 to He/Ethane",     "legend_label": "Gas Switch",
     "start": datetime(2026, 5, 14, 8, 30),    "end": datetime(2026, 5, 14, 9, 30)},
    {"label": "Flush\nHe/Ethane",              "legend_label": "Flush",
     "start": datetime(2026, 5, 14, 10, 0),    "end": datetime(2026, 5, 14, 12, 0)},
    {"label": "Trigger/Scint Testing\nCarbon Capsule", "legend_label": "Testing",
     "start": datetime(2026, 5, 14, 12, 15),   "end": datetime(2026, 5, 14, 14, 15)},
    {"label": "Flush\nHe/Ethane",              "legend_label": "Flush",
     "start": datetime(2026, 5, 14, 14, 30),    "end": datetime(2026, 5, 14, 16, 0)},
    {"label": "Resist HV Scan\nHelium Ethane\n3mm Drift\nB4C", "legend_label": "Measurement",
    ...
    {"label": "Setup\nFlammable Gas Line\nEAR2", "legend_label": "Setup",
     "start": datetime(2026, 5, 15, 10, 45),   "end": datetime(2026, 5, 15, 13, 30)},
    {"label": "Gas Switch\n to Neon Isobutane",     "legend_label": "Gas Switch",
     "start": datetime(2026, 5, 15, 13, 45),    "end": datetime(2026, 5, 15, 14,  45)},
