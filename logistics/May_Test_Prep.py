...
MILESTONES = [
    {"date": datetime(2026, 4, 3),  "label": "Today",                    "color": "#94a3b8"},
    {"date": datetime(2026, 4, 15), "label": "CEA Go-No-Go Meeting",     "color": "white"},
    {"date": datetime(2026, 4, 17), "label": "Test DAQ",                 "color": "#d97706"},
    {"date": datetime(2026, 4, 20), "label": "Screen arrives",           "color": "#7c3aed"},
    {"date": datetime(2026, 4, 28), "label": "Measure Capacitance",      "color": "#7c3aed"},
    {"date": datetime(2026, 5, 6),  "label": "Pack for CERN",            "color": "#f59e0b"},
    {"date": datetime(2026, 5, 7),  "label": "Travel day",               "color": "#94a3b8"},
    {"date": datetime(2026, 5, 8),  "label": "Arrive CERN\nSetup begins","color": "#22d3ee"},
    {"date": datetime(2026, 5, 11), "label": "Beam time\nstarts ★",      "color": "#4ade80"},
]
