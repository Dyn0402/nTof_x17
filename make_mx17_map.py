...
def make_m1_mapping():
    ...
    # Convention: axis label = coordinate the strip measures.
    #   axis='x'  →  strip runs in the Y direction, measures X position (x_position_mm varies)
    #   axis='y'  →  strip runs in the X direction, measures Y position (y_position_mm varies)
    mapping_rows = []
