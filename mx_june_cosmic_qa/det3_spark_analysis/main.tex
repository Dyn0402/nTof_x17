...
reconstruction (the DAQ common-mode cross-talk), on top of a genuinely muon-free
spontaneous component. Cleanly separating those two would need the M3 \emph{raw hits}
(not stored in the ray files) or a spark$\leftrightarrow$M3-noise timing coincidence ---
a further step --- but showers are not the answer.
...
\begin{itemize}\setlength\itemsep{0.15em}
  ...
  \item \textbf{Not showers:} the ``no-track'' sparks are not multi-particle showers ---
        ...
        to muon-tracked sparks (Q2b). The lost M3 track is DAQ cross-talk $+$ spontaneous
        muon-free sparks, not a physics shower.
  \item \textbf{Follow-ups:} (1) inspect the edge / guard-ring field and the Y/FEU8 hot
        ...
        cross-talk} by which a det3 spark spoils M3 tracking (a spark doubles M3's
        no-track rate, $17.5\to34\,\%$) --- next step is M3 raw hits or a spark--M3-noise
        timing coincidence; (3) an offline spark tag (multiplicity $+$ the $\sim$1~\textmu s
