...
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/03_charge_vs_position.py \
    g_det4 sat_det3 o22_long_det2 g_det6_long g_det7_long
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/04_stripe_metrics.py g_det4 --split
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/05_hv_headroom.py
...
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/08_connector_test.py g_det4
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/09_periodicity.py g_det4
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/10_pedestals.py
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/11_strip_break_test.py
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/12_edge_sharpness.py
.venv/bin/python mx_june_cosmic_qa/det4_sps_assessment/13_beam_window.py
