...
\begin{center}\fbox{\parbox{0.92\textwidth}{\small\textbf{SUPERSEDED (2026-07-13) by
\texttt{report\_v2.pdf}.} This document used the pre-v2 $\chi^2<20$ ray recipe; its
$13.7\%$ \recofar\ and low-$X$/left-edge concentration are pre-v2 artefacts. On the v2
recipe ($\chi^2<5$, NClus$\ge3$) the tail is $6.5\%$, spatially uniform, and $\sim$half
reference-tracker error. Kept for history only.}}\end{center}
\vspace{0.5em}
